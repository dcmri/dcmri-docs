...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_tutorials_plot_wex.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_tutorials_plot_wex.py:
...
.. image-sg:: /examples/tutorials/images/sphx_glr_plot_wex_001.png
   :alt: MRI signals, Tissue concentration in indicator compartments, Magnetization in water compartments, Concentration in water compartments
   :srcset: /examples/tutorials/images/sphx_glr_plot_wex_001.png
...
.. image-sg:: /examples/tutorials/images/sphx_glr_plot_wex_002.png
   :alt: MRI signals, Tissue concentration in indicator compartments, Magnetization in water compartments, Concentration in water compartments
   :srcset: /examples/tutorials/images/sphx_glr_plot_wex_002.png
   :class: sphx-glr-single-img
...
.. image-sg:: /examples/tutorials/images/sphx_glr_plot_wex_003.png
   :alt: MRI signals, Tissue concentration in indicator compartments, Magnetization in water compartments, Concentration in water compartments
   :srcset: /examples/tutorials/images/sphx_glr_plot_wex_003.png
   :class: sphx-glr-single-img
...
.. image-sg:: /examples/tutorials/images/sphx_glr_plot_wex_004.png
   :alt: MRI signals, Tissue concentration in indicator compartments, Magnetization in water compartments, Concentration in water compartments
   :srcset: /examples/tutorials/images/sphx_glr_plot_wex_004.png
   :class: sphx-glr-single-img
...
.. image-sg:: /examples/tutorials/images/sphx_glr_plot_wex_005.png
   ...
   :srcset: /examples/tutorials/images/sphx_glr_plot_wex_005.png
   :class: sphx-glr-single-img
...
.. image-sg:: /examples/tutorials/images/sphx_glr_plot_wex_006.png
   :alt: Fast vs no transendothelial indicator exchange
   :srcset: /examples/tutorials/images/sphx_glr_plot_wex_006.png
   :class: sphx-glr-single-img
...
.. image-sg:: /examples/tutorials/images/sphx_glr_plot_wex_007.png
   :alt: MRI signals, Tissue concentration in indicator compartments, Magnetization in water compartments, Concentration in water compartments
   :srcset: /examples/tutorials/images/sphx_glr_plot_wex_007.png
   :class: sphx-glr-single-img
...
.. image-sg:: /examples/tutorials/images/sphx_glr_plot_wex_008.png
   :alt: MRI signals, Tissue concentration in indicator compartments, Magnetization in water compartments, Concentration in water compartments
   :srcset: /examples/tutorials/images/sphx_glr_plot_wex_008.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    PSe: 99.99999381673426 mL/sec/cm3
    PSc: 99.99215333007504 mL/sec/cm3
...
.. image-sg:: /examples/tutorials/images/sphx_glr_plot_wex_009.png
   :alt: Restricted water exchange against extremes
   :srcset: /examples/tutorials/images/sphx_glr_plot_wex_009.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 37.719 seconds)


.. _sphx_glr_download_examples_tutorials_plot_wex.py:
