...
.. "examples\studies\plot_gfr_validation.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_studies_plot_gfr_validation.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_examples_studies_plot_gfr_validation.py:
...
.. image-sg:: /examples/studies/images/sphx_glr_plot_gfr_validation_001.png
   :alt: Single-kidney GFR (SK-GFR)
   :srcset: /examples/studies/images/sphx_glr_plot_gfr_validation_001.png
...
.. image-sg:: /examples/studies/images/sphx_glr_plot_gfr_validation_002.png
   :alt: Single-kidney GFR (SK-GFR)
   :srcset: /examples/studies/images/sphx_glr_plot_gfr_validation_002.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 57.050 seconds)


.. _sphx_glr_download_examples_studies_plot_gfr_validation.py:
