...
Apart from the end-to-end models in the :ref:`tissue bank <e2e>`, 
...
- The :ref:`signal module <bloch>` provides generic signal models for 
  MRI sequences. For more background on these models, see the section on 
  :ref:`imaging sequences <imaging-sequences>`.

- The :ref:`pharmacokinetic building blocks <kinetics>` implement generic 
