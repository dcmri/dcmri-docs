...
.. list-table:: **Tissue parameters**
    ...
    * - Th
      ...
      - sec.
    * - E
      - Hepatocellular extraction fraction
      - Fraction of indicator molecules extracted from the blood pool 
        in a single pass through the liver.
      - dimensionless.
    * - Tg
...
.. list-table:: **Kinetic models for the liver**
    ...
    * - **Single-inlet intracellular**
      ...
      - 
    * - 1I-IC-HFD
      - Single-inlet intracellular with high flow and gut dispersion
      - Tg, Dg, ve, khe, Th
      - Eqs. :eq:`liver-extracellular-disp` and :eq:`liver-hepatocytes`
    * - 1I-IC-HFDU
      - Single-inlet intracellular with high flow, gut dispersion and uptake
      - Tg, Dg, ve, khe
...
**2I-IC**, **2I-IC-HF**, **2I-IC-U**, **1I-IC-HFD** and **1I-IC-HFDU** are direct 
